...
static const struct arg args[] = {
  ...
  { run_command, "^c#89b4fa^[^r0,10,2,4^^r2,7,22,10^^c#000000^^r3,8,20,8^^c#ffffff^^r10,8,13,8^^d^^f24^ ^c#f9e2af^%s", "./.scripts/Batterystatus.sh"},
	...
	{ cpu_perc, "^c#b4befe^[^r2,8,8,8^^r0,6,2,2^^r0,16,2,2^^r10,6,2,2^^r10,16,2,2^^f20^^c#89b4fa^%s%%] ",	 NULL  },
  ...
  { run_command, "^c#eba0ac^[ %s] ",         "./.scripts/Mic.sh"},
	...
	{ datetime, "^c#cba6f7^[^r0,6,1,12^^r17,6,1,12^^r1,5,16,1^^r0,9,17,1^^r1,18,16,1^^r2,11,2,2^^r6,11,2,2^^r10,11,2,2^^r14,11,2,2^^r2,15,2,2^^r6,15,2,2^^r10,15,2,2^^f24^%s",           "%F][%T]   "  },
};
